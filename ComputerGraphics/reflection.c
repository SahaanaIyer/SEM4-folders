...
//	p matrix	vertices		reflect matrix
//	0	0	1	(0,0)			1	0	0		reflect along y=0 line
//	50	0	1	(100,0)		   	0	-1	0
//	50	50	1	(50,50)			0	0	1

	float p[3][3] = {{0, 0, 1}, {100, 0, 1}, {50, 50, 1}};	//enter the vertices of triangle here
	float reflect[3][3]={{1, 0, 0}, {0, -1, 0}, {0, 0, 1}};		//reflect matrix along x axis
	float r[3][3] = {0};	//result matrix - the reflected vertices are stored here
	...
	mat_multiply(p, reflect, r);

	glColor3f(0, 1, 0);	//color selected is green
	//Display Reflected Polygon
	glBegin(GL_POLYGON);
...
int main(int argv, char **argc)
{
	...
	glutCreateWindow("Reflection");		//syntax - glutCreateWindow("window title here")
